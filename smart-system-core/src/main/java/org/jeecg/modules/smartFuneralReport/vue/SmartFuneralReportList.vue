        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="工作单位">
              <a-input placeholder="请输入工作单位" v-model="queryParam.departJd"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'reportPeople',text:'报备人ID',dictCode:''})
        fieldList.push({type:'string',value:'departJd',text:'工作单位',dictCode:''})

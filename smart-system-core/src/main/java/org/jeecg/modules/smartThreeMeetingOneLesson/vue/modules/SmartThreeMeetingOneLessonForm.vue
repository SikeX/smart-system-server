    ...
    <j-form-container :disabled="formDisabled">
      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24" >
            <a-form-model-item label="主持人工号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="hostNumber">
              <a-input v-model="model.hostNumber" placeholder="请输入主持人工号" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
            <a-form-model-item label="记录人工号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="recorderNumber">
              <a-input v-model="model.recorderNumber" placeholder="请输入记录人工号" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >

package org.jeecg.modules.smart_qrCode.controller; /**
...
import org.jeecg.modules.qrCode.controller.BaseController;
import org.jeecg.modules.smart_qrCode.entity.QRCodeUtil;
...
*/
   ...
   public BaseResponse generateV2(String content,HttpServletResponse servletResponse){
       BaseResponse response=new BaseResponse(StatusCode.Success);
       content="http://192.168.73.247:3000/SmartEvaluate/modules/SmartEvaluateForm";
       try {
           QRCodeUtil.createCodeToOutputStream(content,servletResponse.getOutputStream());

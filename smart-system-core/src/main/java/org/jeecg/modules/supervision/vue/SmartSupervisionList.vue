<template>
  <a-card :bordered="false">
    ...
    <smart-supervision-modal ref="modalForm" @ok="modalFormOk"></smart-supervision-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/supervision/smartSupervision/list",
          delete: "/supervision/smartSupervision/delete",
          deleteBatch: "/supervision/smartSupervision/deleteBatch",
          exportXlsUrl: "/supervision/smartSupervision/exportXls",
          importExcelUrl: "supervision/smartSupervision/importExcel",

        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="工作开始时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="workTime">
              <j-date placeholder="请选择工作开始时间" v-model="model.workTime" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="上报人" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="uploadUser">
              <a-input v-model="model.uploadUser"placeholder="请输入上报人" disabled></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="上传时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="createTime">
              <j-date placeholder="请选择上传时间" v-model="model.createTime" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" disabled/>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>

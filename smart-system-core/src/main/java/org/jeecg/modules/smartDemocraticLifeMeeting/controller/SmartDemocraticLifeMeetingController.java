...
public class SmartDemocraticLifeMeetingController extends JeecgController<SmartDemocraticLifeMeeting, ISmartDemocraticLifeMeetingService> {
    ...
    /*--------------------------------子表处理-民主生活会参会人员表-begin----------------------------------------------*/
	/**
	 * 通过主表ID查询
	 * @return
	 */
	@AutoLog(value = "民主生活会参会人员表-通过主表ID查询")
	@ApiOperation(value="民主生活会参会人员表-通过主表ID查询", notes="民主生活会参会人员表-通过主表ID查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "民主生活会参会人员表-添加")
	@ApiOperation(value="民主生活会参会人员表-添加", notes="民主生活会参会人员表-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "民主生活会参会人员表-编辑")
	@ApiOperation(value="民主生活会参会人员表-编辑", notes="民主生活会参会人员表-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "民主生活会参会人员表-通过id删除")
	@ApiOperation(value="民主生活会参会人员表-通过id删除", notes="民主生活会参会人员表-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "民主生活会参会人员表-批量删除")
	@ApiOperation(value="民主生活会参会人员表-批量删除", notes="民主生活会参会人员表-批量删除")
    ...
    public ModelAndView exportSmartDemocraticLifePeople(HttpServletRequest request, SmartDemocraticLifePeople smartDemocraticLifePeople) {
		 ...
		 mv.addObject(NormalExcelConstants.FILE_NAME, "民主生活会参会人员表"); //此处设置的filename无效 ,前端会重更新设置一下
		 mv.addObject(NormalExcelConstants.CLASS, SmartDemocraticLifePeople.class);
		 mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("民主生活会参会人员表报表", "导出人:" + sysUser.getRealname(), "民主生活会参会人员表"));

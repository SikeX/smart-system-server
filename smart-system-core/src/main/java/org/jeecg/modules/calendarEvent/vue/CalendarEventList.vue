...
<script>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            align:"center",
            dataIndex: 'allDay',
            customRender: (text) => (text ? filterMultiDictText(this.dictOptions['allDay'], text) : ''),
          },
          {
            title: '操作',
            dataIndex: 'action',
    ...
    created() {
      this.$set(this.dictOptions, 'allDay', [{text:'是',value:'Y'},{text:'否',value:'N'}])
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'switch',value:'allDay',text:'整天'})

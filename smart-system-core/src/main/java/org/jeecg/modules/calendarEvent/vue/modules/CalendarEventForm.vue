    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="完成情况" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="isFinished">
              <j-dict-select-tag type="list" v-model="model.isFinished" dictCode="" placeholder="请选择完成情况" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="整天" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="allDay">
              <j-switch v-model="model.allDay"  ></j-switch>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>

...
public class BannerController extends JeecgController<Banner, IBannerService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "app功能管理-分页列表查询")
	@ApiOperation(value="app功能管理-分页列表查询", notes="app功能管理-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "app功能管理-添加")
	@ApiOperation(value="app功能管理-添加", notes="app功能管理-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "app功能管理-编辑")
	@ApiOperation(value="app功能管理-编辑", notes="app功能管理-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "app功能管理-通过id删除")
	@ApiOperation(value="app功能管理-通过id删除", notes="app功能管理-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "app功能管理-批量删除")
	@ApiOperation(value="app功能管理-批量删除", notes="app功能管理-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "app功能管理-通过id查询")
	@ApiOperation(value="app功能管理-通过id查询", notes="app功能管理-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Banner banner) {
        return super.exportXls(request, banner, Banner.class, "app功能管理");
    }

...
public class AppUser {
    ...
    public AppUser(int id, String clientId, String androidId, String lastLoginIp, String mac, String appVersion, String brand, String phoneModel, int lastLoginTime, String sysUserId, String phone, int status, int ctime, int mtime) {
        this.id = id;

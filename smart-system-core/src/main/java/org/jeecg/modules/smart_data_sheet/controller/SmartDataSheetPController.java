...
@Api(tags="资料库")
@RestController
@RequestMapping("/smart_data_sheet/smartDataSheetP")
@Slf4j
public class SmartDataSheetPController {
	@Autowired
...
////		"%5B%7B%22rule%22:%22"+rule+  "%22,%22type%22:%22int%22,%22dictCode%22:%22type_data%22,%22val%22:%220%22,%22field%22:%22"+field+"%22%7D%5D"
		...
		QueryWrapper<SmartDataSheet> queryWrapper = QueryGenerator.initQueryWrapper(smartDataSheet, map);

<template>
  <a-card :bordered="false">
    ...
    <smartAssessmentContent-modal ref="modalForm" @ok="modalFormOk"></smartAssessmentContent-modal>
  </a-card>
</template>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'考核单位评分人员',
            align:"left",
            dataIndex: 'assDepartUser_dictText'
          },
          {
            title:'考核组',
            align:"left",
            dataIndex: 'assTeam_dictText'
          },
          {
            title:'排序',
            align:"left",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'sel_search',value:'assTeam',text:'考核组',dictTable:'smart_assessment_team', dictText:'team_name', dictCode:'id'})
